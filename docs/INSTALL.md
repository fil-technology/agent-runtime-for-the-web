...
[v0.3.1 release tarballs](https://github.com/fil-technology/agent-runtime-for-the-web/releases/tag/v0.3.1).
...
```bash
pnpm add https://github.com/fil-technology/agent-runtime-for-the-web/releases/download/v0.3.1/agent-runtime-core-0.3.1.tgz \
         https://github.com/fil-technology/agent-runtime-for-the-web/releases/download/v0.3.1/agent-runtime-react-0.3.1.tgz \
         https://github.com/fil-technology/agent-runtime-for-the-web/releases/download/v0.3.1/agent-runtime-next-0.3.1.tgz
```

Install them **in one command**. They depend on each other by version, so adding them one at a
time sends the package manager to the npm registry for `@agent-runtime/core@0.3.1`, which is not
published yet.
...
```bash
pnpm add https://github.com/fil-technology/agent-runtime-for-the-web/releases/download/v0.3.1/agent-runtime-cloud-0.3.1.tgz   # AI SDK, Anthropic, OpenAI-compatible
pnpm add https://github.com/fil-technology/agent-runtime-for-the-web/releases/download/v0.3.1/agent-runtime-local-0.3.1.tgz   # on-device models
```
