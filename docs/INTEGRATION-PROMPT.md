...
pnpm add https://github.com/fil-technology/agent-runtime-for-the-web/releases/download/v0.3.0/agent-runtime-core-0.3.0.tgz https://github.com/fil-technology/agent-runtime-for-the-web/releases/download/v0.3.0/agent-runtime-react-0.3.0.tgz https://github.com/fil-technology/agent-runtime-for-the-web/releases/download/v0.3.0/agent-runtime-next-0.3.0.tgz
